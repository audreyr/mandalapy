...
def MandalaPy(it,points,radius):
    ...
    voronoi_plot_2d(mandala, show_points = False, show_vertices = False, ), plt.axis('off'), plt.gca().set_aspect('equal', adjustable='box'), plt.savefig('mandala.svg'), plt.savefig('mandala.png', dpi = 100)
    return plt.show()
